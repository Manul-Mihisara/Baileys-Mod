# <div align='center'>WhatsApp Web API - Modified by Fuxxy</div>

<div align='center'>

**Baileys - Modified by [Fuxxy](https://github.com/J-Forces)**

Contact: **6282113443806** (for Baileys-related issues)
...
```bash
npm install @fuxxy-star/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @fuxxy-star/baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@fuxxy-star/baileys")
```
...
```javascript
const makeWASocket = require("@fuxxy-star/baileys").default;
const { useMultiFileAuthState } = require("@fuxxy-star/baileys");
...
```javascript
const makeWASocket = require("@fuxxy-star/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@fuxxy-star/baileys");
...
```javascript
const makeWASocket = require("@fuxxy-star/baileys").default;
const { makeInMemoryStore } = require("@fuxxy-star/baileys");
...
const { downloadMediaMessage, getContentType } = require("@fuxxy-star/baileys");
...
**Need help with this modified version? Contact Fuxxy at 6282113443806**